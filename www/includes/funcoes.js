...
function divCarregando(id){
	...
	.append('<center><b>Carregando...</b></center>');
...
function isDataFutura(elem){
	var data    = elem.value;
	var objData = new Data();
	return objData.comparaData(data, objData.montaData(new Date()), ">");
}
