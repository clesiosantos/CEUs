...
<?
	  $sql = "select
	  			a.prgcod, p.prgdsc, a.acacod, 
	  			a.acadsc, p.prgid, count(*) as totalaca 
	  		  from
	  		    elabrev.ppaacao_proposta a inner join elabrev.ppaprograma_proposta p on a.prgid = p.prgid 
	  		  where
	  		    a.acastatus='A' and 
	  		  ...
	  		  group by
	  		    ...
	  		    a.acadsc, p.prgid 
	  		  order by
	  		    a.prgcod, a.acacod, a.acadsc";
	  $RS = (array) $db->carregar($sql);
